...
const Subscribe = () => {
    ...
    return (
        <div className="flex flex-rows md:flex-cols items-center justify-between bg-blue-200 lg:px-52 md:px-14 px-4 py-2">
            <div>
            ...
            <div>
                <img style={{maxHeight:"15rem"}} className="hidden sm:block" src={pic} alt='tourist'></img>
            </div>
        </div>
    )
}
